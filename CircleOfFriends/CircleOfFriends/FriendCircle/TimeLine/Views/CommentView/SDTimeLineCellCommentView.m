...
- (void)setupViews
{
    ...
    _bgImageView.backgroundColor = BACKVIEW_COLOR;
...
- (void)setLikeItemsArray:(NSArray *)likeItemsArray
{
    ...
    NSMutableAttributedString* countStr  = [[NSMutableAttributedString alloc] initWithString:PXY_STR(@" , %ld 人",likeItemsArray.count)];
    [countStr addAttribute:NSFontAttributeName
                     value:[UIFont systemFontOfSize:13]
                     range:NSMakeRange(0, countStr.length)];
    [attributedText appendAttributedString:countStr];
...
- (void)setupWithLikeItemsArray:(NSArray *)likeItemsArray commentItemsArray:(NSArray *)commentItemsArray
{
    ...
    for ( SDTimeLineCellCommentItemModel *model in commentItemsArray) {
