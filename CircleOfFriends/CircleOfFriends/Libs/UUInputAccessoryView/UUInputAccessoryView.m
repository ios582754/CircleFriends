...
+ (UUInputAccessoryView *)sharedView {
    ...
    dispatch_once(&once, ^ {
        ...
        [saveBtn setTitle:@"评论" forState:UIControlStateSelected];
...
+ (void)showKeyboardConfige:(UUInputAccessoryConfige _Nullable)confige  content:(NSString * _Nullable)btnTitle  block:(UUInputAccessoryBlock _Nullable)block
{
    UUInputConfiger *configer = [UUInputConfiger new];
    !confige?:confige(configer);
    [[self sharedView]->BtnSave setTitle:btnTitle forState:UIControlStateNormal];
    [[self sharedView]->BtnSave setTitle:btnTitle forState:UIControlStateSelected];
...
//    [[ UUInputAccessoryView sharedView ] btnClick];
    [[ UUInputAccessoryView sharedView ] dismiss];
